...
func TestCodeDiffRendersFilePath(t *testing.T) {
	...
	diff := c.RenderCodeDiffV2("test.go", oldCode, newCode, 1)
...
func TestCodeDiffLineWidthEqualsViewport(t *testing.T) {
	c := components.NewChat(80, 24)
...
func TestCodeDiffNoBareResets(t *testing.T) {
	c := components.NewChat(80, 24)
...
func TestCodeDiffHasTopPadding(t *testing.T) {
	c := components.NewChat(80, 24)
...
func TestCodeDiffAddColors(t *testing.T) {
	c := components.NewChat(80, 24)
...
func TestCodeDiffRemoveColors(t *testing.T) {
	c := components.NewChat(80, 24)
...
func TestCodeDiffWrappedLinesHaveBackground(t *testing.T) {
...
func TestCodeDiffStartLineOnlyComputesEndLine(t *testing.T) {
	c := components.NewChat(80, 24)
...
func TestCodeDiffSingleLineStartLineOnly(t *testing.T) {
	c := components.NewChat(80, 24)
	...
	diff := c.RenderCodeDiffV2("test.go", oldCode, newCode, 5)
...
func TestCodeDiffRemovedLinesUseOldFileNumbers(t *testing.T) {
	c := components.NewChat(80, 24)
...
func world() {}`
	...
	diff := c.RenderCodeDiffV2("test.go", oldCode, newCode, 10)
	cleanDiff := stripAnsi(diff)
...
func TestCodeDiffAddedLinesUseNewFileNumbers(t *testing.T) {
	c := components.NewChat(80, 24)
